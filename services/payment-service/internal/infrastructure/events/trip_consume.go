...
func NewTripConsumer(rabbitmq *messages.RabbitMQ, service domain.Service) *TripConsumer {
	return &TripConsumer{
		rabbitmq: rabbitmq,
		service:  service,
	}
...
func (c *TripConsumer) Listen() error {
	return c.rabbitmq.ConsumeMessages(messages.PaymentTripResponseQueue, func(ctx context.Context, msg amqp091.Delivery) error {
		...
		var payload messages.PaymentTripResponseData
...
func (c *TripConsumer) handleTripAccepted(ctx context.Context, payload messages.PaymentTripResponseData) error {
	...
	paymentPayload := messages.PaymentEventSessionCreatedData{
